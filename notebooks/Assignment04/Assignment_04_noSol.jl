...
begin
 ...
 m2 = 4
 C31 = c3/m2 * F3
 DT3 = vec(Array(select(DT[1:1:8,:],"D(T)")))
...
Markdown.parse("
- Calculate the price of a $(T3)-year bond, with a $(c3*100) percent coupon rate (paid quarterly) and a face value of $(F3). Use the discount factor data provided in the table above.
")
...
md"""
Replicate bond D’s cash flows using a portfolio of bonds A, B, and C. What is the price of bond D?
