...
begin 
	...
	<p style="padding-bottom:1cm"> </p>
	<p align=center style="font-size:25px; font-family:family:Georgia"> <b> Assignment 1</b> <p>
	<p align=center style="font-size:25px; font-family:family:Georgia"> <b> Treasury Securities</b> <p>
	<p style="padding-bottom:1cm"> </p>
...
md"""
- Use the Bloomberg system to search for a Treasury note.
...
2. Describe the characteristics of the Treasury note you selected that are shown on the security description page. Characteristics include the issue date, the maturity date, the coupon rate and coupon frequency, the amount outstanding, the price of the Treasury note when it was issued, the amount issued, etc.
3. Use the Bloomberg terminal to show the dates and the dollar amount of the coupon cash flows from the Treasury note you selected.
4. Use the Bloomberg terminal to show the prices of the Treasury selected over the last six-month period.
"""

# ╔═╡ e796c3d9-dd1f-452d-9700-9598227a249e
md"""
!!! hint
    - For part 2, follow the procedure we used on page 15 of the lecture notes to Lecture 02.
    - For part 3, first go to the security description page using DES as in part 1. Next, type `CSHF` and press enter.
    - For part 4, you can type `GP` at the security description screen.
"""
...
md"""
- Use the Bloomberg system to search for a Treasury bill.
- Go to the security description page.
1. Take a screenshot of the security description page (include this screenshot in your submission).
2. Describe the characteristics of the Treasury bill you selected that are shown on the security description page. Characteristics include the issue date, the maturity date, the amount oustanding, etc.
3. Does the Treasury bill you selected pay any coupon cash flows?
"""

# ╔═╡ 7ffe7976-a85e-47d5-bb8f-df82c74aeb43
md"""
!!! hint
    Follow the procedure we used in the lecture notes to Lecture 02 (refer to the section about Treasury bills).
"""
...
manifest_format = "2.0"
project_hash = "8e6025b1d79c109eca7884994ad9a6b2e05f3ee7"
